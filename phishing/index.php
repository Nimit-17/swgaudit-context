          ...
          <div class="test-card-detail" id="phishing-evasion-detection-test-1-detail" hidden>
            <div class="test-picker">
              ...
              <select id="phishing-url-manipulation-case" data-url-manipulation-select>
                <option value="/phishing/rnicrosoft-Iogin/" data-description="Lookalike path using rn for m and uppercase I for l. Opens the controlled Microsoft-style page directly.">Lookalike path - rnicrosoft-Iogin</option>
